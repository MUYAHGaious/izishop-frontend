...
const SettingsOverlay = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center p-4 animate-fadeIn" style={{ backdropFilter: 'blur(8px)' }}>
      <div className="bg-white/95 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden animate-slideUp">
        ...
        <div className="flex h-[calc(90vh-160px)]">
          {/* Sidebar Navigation */}
          <div className="w-60 bg-gradient-to-b from-gray-50/80 to-white/50 backdrop-blur-sm border-r border-white/20 p-4">
            {/* User Info Card */}
            <div className="mb-6 p-3 bg-white/60 backdrop-blur-sm rounded-xl border border-white/20 shadow-sm">
              ...
              {activeTab === 'appearance' && (
                <div className="space-y-6 animate-fadeIn">
                  <div>
                    ...
                    {/* Language Selection */}
                    <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-white/20 p-6 shadow-sm mt-4">
        ...
        {/* Modern Footer */}
        <div className="border-t border-white/20 bg-gradient-to-r from-gray-50/90 to-white/50 backdrop-blur-sm p-4">

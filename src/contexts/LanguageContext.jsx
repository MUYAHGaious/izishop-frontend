...
const translations = {
  'en-GB': {
    ...
    // Footer
    'footer.companyDescription': "Cameroon's trusted marketplace — shop and sell with secure MTN MoMo, Orange Money & Visa payments.",
    'footer.stayConnected': 'Stay Connected',
    'footer.contactInfo': 'Contact Information',
    'footer.platformInfo': 'Platform',
    'footer.secondHandMarket': 'Second-hand Market',
    'footer.privacyPolicy': 'Privacy Policy',
    'footer.termsOfService': 'Terms of Service',
    'footer.cookiePolicy': 'Cookie Policy',
    'footer.accessibility': 'Accessibility',
    'footer.acceptedPaymentMethods': 'Accepted Payment Methods',
  ...
  'fr': {
    ...
    // Footer
    'footer.companyDescription': "La marketplace de confiance du Cameroun — achetez et vendez avec MTN MoMo, Orange Money et Visa.",
    'footer.stayConnected': 'Restez connecté',
    'footer.contactInfo': 'Coordonnées',
    'footer.platformInfo': 'Plateforme',
    'footer.secondHandMarket': "Marché d'occasion",
    'footer.privacyPolicy': 'Politique de confidentialité',
    'footer.termsOfService': "Conditions d'utilisation",
    'footer.cookiePolicy': 'Politique des cookies',
    'footer.accessibility': 'Accessibilité',
    'footer.acceptedPaymentMethods': 'Moyens de paiement acceptés',
    'footer.sslSecured': 'Sécurisé SSL',
    'footer.verifiedPlatform': 'Plateforme vérifiée',
    'footer.marketplace': 'Marketplace',

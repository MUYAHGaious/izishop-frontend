      ...
      <div className="fixed bottom-6 right-6 z-[9998] flex flex-col items-end">
          ...
          <div className="flex flex-col gap-3">
            {quickActions.map((action, index) => {
              ...
              return (
                ...
                >
                  {/* Action Label */}
                  <div className="bg-white text-gray-900 px-4 py-3 rounded-xl shadow-lg border border-gray-200 min-w-0 flex-shrink-0">
            ...
            {/* Info Card */}
            <div className="bg-white text-gray-900 px-4 py-3 rounded-xl shadow-lg border border-gray-200 mt-2">
              <div className="flex items-center gap-2 mb-2">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500 flex items-center gap-1">
                    <div className={`w-2 h-2 rounded-full ${isOnline ? 'bg-green-400' : 'bg-gray-400'} ${isOnline ? 'animate-pulse' : ''}`}></div>
        ...
        <div className="relative">
          <button
            ...
            className={`w-14 h-14 bg-primary hover:bg-primary-hover rounded-full flex items-center justify-center shadow-xl hover:shadow-2xl transform hover:scale-110 transition-all duration-300 text-white ${
          ...
          >
            ...
            {!isExpanded && unreadCount > 0 && (
              <>
                <div className="absolute inset-0 rounded-full bg-primary opacity-5 animate-ping"></div>
              </>
            )}
          </button>

...
when i clik sign up it tke me to the fist srepper then when i clikthe  input  
   to selete role its cover like lik displayiedinsded the box it seem the       
  input fields on the pages havet ben upgraded fix that onthe  http://localhost:4028/authentication-login-register